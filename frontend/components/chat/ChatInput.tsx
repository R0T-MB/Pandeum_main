...
export const ChatInput = ({ onSend, disabled, onQuickFilter }: ChatInputProps) => {
  ...
  return (
    <div className="space-y-3">
      {/* Premium Input */}
      <div className="flex items-end gap-2 bg-[#111827] rounded-2xl border border-[rgba(255,255,255,0.08)] px-4 py-3 transition-all duration-200 focus-within:border-[#7C3AED]/50 focus-within:shadow-lg focus-within:shadow-[#7C3AED]/15 pandeum-glow">
