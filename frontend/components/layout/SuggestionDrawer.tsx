...
export function SuggestionDrawer({ isOpen, onClose, providers = [] }: SuggestionDrawerProps) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed right-0 top-0 z-50 h-full w-[360px] border-l border-[rgba(255,255,255,0.08)] bg-[#111521] overflow-y-auto scrollbar-thin transition-all duration-300 ease-out ${
          isOpen ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0 pointer-events-none'
        }`}
      >
        <div className="sticky top-0 z-10 flex items-center justify-between px-5 py-4 bg-[#111521]/95 backdrop-blur-xl border-b border-[rgba(255,255,255,0.08)]">
          ...
          <button
            onClick={onClose}
            className="p-2 rounded-[14px] hover:bg-[rgba(255,255,255,0.05)] transition-all duration-200 text-[#9CA3AF] hover:text-white"
          >
