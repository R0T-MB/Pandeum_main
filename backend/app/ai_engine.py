...
class AIEngine:
    ...
    def _is_continuation_phrase(problem_lower: str) -> bool:
        continuation_patterns = [
            ...
            r'\b(recomendar|recomiendas|recomiéndame|recomiendame) a alguien\b',
            r'\ba quién (llamo|busco|contrato|encuentro)\b',
            r'\ba quien (llamo|busco|contrato|encuentro)\b',
            r'\bquién me (ayuda|puede ayudar|recomienda)\b',
            r'\bquien me (ayuda|puede ayudar|recomienda)\b',
            r'\b(necesito|busco) un técnico\b',
            r'\b(necesito|busco) un profesional\b',
            r'\b(necesito|busco) un especialista\b',
            r'\b(necesito|busco) a alguien\b',
            r'\b(necesito|busco) quien (arregle|repare|haga|instale)\b',
            r'\b(necesito|busco) quién (arregle|repare|haga|instale)\b',
            r'\b(quiero|necesito) contratar\b',
            r'\b(quiero|necesito) cotizar\b',
            r'\b(quiero|necesito) un proveedor\b',
            r'\balgún (técnico|proveedor|profesional|especialista|lugar)\b',
            r'\balguna (tienda|persona|empresa)\b',
            r'\bdónde encuentro\b',
            r'\bdonde encuentro\b',
            r'\bdónde consigo\b',
            r'\bdonde consigo\b',
...
"""
    ...
    def _resolve_intent_locally(
        ...
        if is_ambiguous:
            ...
            asks_for_place = any(p in problem_lower for p in [
                ...
                'a quién', 'a quien', 'quién me', 'quien me',
                'necesito un técnico', 'necesito un profesional', 'necesito un especialista',
                'busco un técnico', 'busco un profesional', 'busco un especialista',
                'necesito a alguien', 'busco a alguien',
                'necesito quien', 'busco quien',
                'quiero contratar', 'necesito contratar',
                'quiero cotizar', 'necesito cotizar',
                'quiero un proveedor', 'necesito un proveedor',
                'algún técnico', 'algún proveedor', 'algún profesional', 'algún especialista',
                'dónde encuentro', 'donde encuentro',
                'dónde consigo', 'donde consigo',
            ]) or is_continuation
    ...
    def _detect_response_mode(problem: str, conversation_context: Optional[List[Dict]] = None) -> str:
        ...
        lugar_ambiguous_phrases = [
            ...
            'recomiendas a alguien', 'recomiéndame a alguien', 'recomiendame a alguien',
            'a quién llamo', 'a quien llamo', 'quién me ayuda', 'quien me ayuda',
            'quién me recomienda', 'quien me recomienda',
            'necesito un técnico', 'busco un técnico',
            'necesito un profesional', 'busco un profesional',
            'necesito un especialista', 'busco un especialista',
            'necesito a alguien', 'busco a alguien',
            'quiero contratar', 'necesito contratar',
            'quiero un proveedor', 'necesito un proveedor',
            'algún técnico', 'algún proveedor', 'algún profesional', 'algún especialista',
                ...
                if provider_name:
                    ...
                    if db_provider:
                        ...
                        recommended_providers.append({
                            ...
                            "rating": rating,
                            "avatar_url": db_provider.avatar_url,
